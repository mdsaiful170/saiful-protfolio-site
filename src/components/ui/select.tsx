...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "bg-[#0c1810] flex items-center justify-between   box-shadow text-sm font-medium font-JetBrains tracking-tight md:text-base   focus:border-lightSkey/15 focus:valid:border-lightSkey/15 placeholder:font-normal placeholder:text-sm placeholder:text-textColor/50 border border-textColor/5 px-3 py-2.5 rounded-md outline-none valid:border-lightSkey/15",
      className
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none tracking-tight items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-lightSkey/40 focus:text-textColor data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-zinc-800 dark:focus:text-zinc-50",
      className
    )}
    {...props}
  >
